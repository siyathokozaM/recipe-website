...
//       <div className="recipe container justifty-content-center pt-5 ">
...
//                 <i class="fa fa-star" aria-hidden="true"></i>({detail.rating})
//               </span>
//               <span className="p-3" id="users">
//                 <i class="fa fa-user" aria-hidden="true"></i>({detail.users})
//               </span>
//             </p>
...
//                 <li key={index}>
//                   <img className="list-icon p-1" src="../images/chef-hat.png" />
//                   {ingred}
//                 </li>
//               ))}
//             </ul>
...
export default function Recipes() {
  ...
  useEffect(() => {
    // Find the recipe with the matching 'id' in your data
